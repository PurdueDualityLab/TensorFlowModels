...
'''
python3 -m yolo.train_vm --mode=train_and_eval --experiment=yolo_v4_coco --model_dir=../checkpoints/yolov4-2014 --config_file=yolo/configs/experiments/yolov4-64-2014.yaml
'''
def main(_):
