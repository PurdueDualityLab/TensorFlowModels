...
Train = preprocessing_functions.preprocessing(
    Train, 50, "classification", Size, 1000, 1001, 224
)  # https://www.calculatorsoup.com/calculators/math/factors.php -> Check to find a good batch size
