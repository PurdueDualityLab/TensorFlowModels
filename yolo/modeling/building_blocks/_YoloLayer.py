...
class YoloFilterCell(ks.layers.Layer):
    def __init__(self, anchors, thresh, path_scale, path_key = None, max_box = 200, **kwargs):
...
class YoloLayer(ks.Model):
    ...
    def build(self, input_shape):
        ...
        for i, key in enumerate(self._keys):
            ...
            self._filters[key] = YoloFilterCell(anchors = anchors, thresh = self._thresh, path_key = key, max_box = self._max_boxes, path_scale = self._path_scale[key])
        return
