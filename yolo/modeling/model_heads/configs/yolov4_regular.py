...
"256":{
      ...
      "processor_conditions":{"filters": 256, "use_bn":True, "kernel_size":(3, 3),"strides":(1, 1),"padding":'same'},
...
"512":{
      ...
      "resample_conditions":{"filters": 512, "downsample":True},
...
"1024":{
      "depth":512,
      "resample": 'yolo>DarkRoute',
      "resample_conditions":{"filters": 256, "downsample":True},
      "processor": 'yolo>DarkRouteProcess',
      "processor_conditions":{"filters": 1024, "repetitions": 3, "insert_spp": False},
      "output_conditions":{"kernel_size":(1, 1), "strides":(1, 1), "padding":"same", "use_bn":False, "activation":None},
      "output-extras": 0,
   },
}
