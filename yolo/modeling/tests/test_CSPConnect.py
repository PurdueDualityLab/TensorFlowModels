...
from yolo.modeling.building_blocks import CSPDownSample as layer
from yolo.modeling.building_blocks import CSPConnect as layer_companion
...
class CSPConnect(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_pass_through(self, width, height, filters, mod):
        ...
        self.assertAllEqual(outx.shape.as_list(), [None, np.ceil(width//2), np.ceil(height//2), (filters)])
        return
