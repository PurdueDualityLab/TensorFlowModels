...
class Yolo(ks.Model):
    def __init__(
        ...
        if boxes == "default":    
            if model_type == "tiny":
                self._boxes = [(10, 14), (23, 27), (37, 58),(81, 82), (135, 169), (344, 319)]
            elif model_version == "v4":
                self._boxes = [(12, 16), (19, 36), (40, 28), (36, 75),(76, 55), (72, 146), (142, 110),(192, 243), (459, 401)]
            else: 
                self._boxes = [(10, 13), (16, 30), (33, 23),(30, 61), (62, 45), (59, 119),(116, 90), (156, 198), (373, 326)]
        ...
        if model_version == "v4":
            ...
            if model_type == "tiny":
                ...
                model_id = "darknet53"
        self._backbone = Darknet(model_id=model_id, max_level=max_level, min_level=min_level)

        if model_type == "tiny":
            self._head = YoloDecoder(classes = 80, boxes_per_level = 3, embed_spp= False, embed_fpn = False, max_level_process_len=2, path_process_len=1)
        elif model_version == "v4":
            self._head = YoloDecoder(classes = 80, boxes_per_level = 3, embed_spp= False, embed_fpn = True, max_level_process_len=None, path_process_len=6)
        elif model_type == "spp":
            self._head = YoloDecoder(classes = 80, boxes_per_level = 3, embed_spp= True, embed_fpn = False, max_level_process_len=None, path_process_len=6)
        else: 
            self._head = YoloDecoder(classes = 80, boxes_per_level = 3, embed_spp= False, embed_fpn = False, max_level_process_len=None, path_process_len=6)
        return
    ...
    def load_weights_from_dn(self,
        ...
        if dn2tf_backbone or dn2tf_head:
            ...
            if dn2tf_head:
                ...
                load_head(self.head.head, decoder, out_conv = self.head.output_depth)
