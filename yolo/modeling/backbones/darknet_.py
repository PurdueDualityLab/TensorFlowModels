...
#         ],
#         [
#             'DarkRes', 'csp_swin', 4, False, 128, None, None, None, None, 'mish', -1,
#             1, 2, False
#         ],
#         [
#             'DarkRes', 'csp_swin', 8, False, 256, None, None, None, None, 'mish', -1,
#             1, 3, True
#         ],
#         [
#             'DarkRes', 'csp_swin', 8, False, 512, None, None, None, None, 'mish', -1,
#             2, 4, True
#         ],
#         [
#             'DarkRes', 'csp_swin', 4, False, 1024, None, None, None, None, 'mish',
#             -1, 4, 5, True
#         ],
#     ]
# }
...
CSPSWINDARKNET53 = {
    ...
    'backbone': [
        [
            'ConvBN', None, 1, False, 24, None, 3, 1, 'same', 'mish', -1, 1, 0,
            False
        ],
        [
            'DarkRes', 'csp', 1, True, 48, None, None, None, None, 'mish', -1,
            1, 1, False
        ],
        [
            'DarkRes', 'csp_swin', 4, False, 96, None, None, None, None, 'mish', -1,
            1, 2, False
        ],
        [
            'DarkRes', 'csp_swin', 8, False, 192, None, None, None, None, 'mish', -1,
            1, 3, True
        ],
        [
            'DarkRes', 'csp_swin', 8, False, 384, None, None, None, None, 'mish', -1,
            2, 4, True
        ],
        [
            'DarkRes', 'csp_swin', 4, False, 768, None, None, None, None, 'mish',
            -1, 4, 5, True
        ],
    ]
}
...
class Darknet(tf.keras.Model):
    ...
    for i, config in enumerate(net):
      ...
      if config.stack is None:
        ...
        x = self._csp_stack(
            stack_outputs[config.route], config, name=f'{config.layer}_{i}')
        stack_outputs.append(x)
      elif config.stack == 'csp_swin':
        x = self._csp_swin_stack(
            stack_outputs[config.route], config, name=f'{config.layer}_{i}')
        stack_outputs.append(x)
  ...
  def _csp_swin_stack(self, inputs, config, name):
    if config.bottleneck:
      csp_filter_scale = 1
      residual_filter_scale = 2
      scale_filters = 1
...
if __name__ == "__main__":
    model = Darknet(
        ...
        min_level=3,
        max_level=5,
        input_specs=tf.keras.layers.InputSpec(shape=[None, 416, 416, 3]),
        dilate=False,
        activation="gelu",
    )
