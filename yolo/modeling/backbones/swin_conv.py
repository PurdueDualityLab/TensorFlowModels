...
from yolo.modeling.layers import attention_blocks_conv as attention_blocks

@tf.keras.utils.register_keras_serializable(package='yolo')
class SwinTransformerConv(tf.keras.Model):
...
@factory.register_backbone_builder('swin_conv')
def build_swin_conv(
