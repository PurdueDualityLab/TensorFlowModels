...
from yolo.common import registry_imports  # pylint: disable=unused-import
...
flags.DEFINE_string(
    'saved_model_dir', None, 'The directory to the saved model.')
flags.DEFINE_string(
    'tflite_path', None, 'The path to the output tflite model.')
flags.DEFINE_string(
    'quant_type',
    default=None,
...
""" python3.8 -m yolo.serving.export_tflite --experiment scaled_yolo --config_file yolo/configs/experiments/yolov4-csp/inference/640.yaml  --saved_model_dir cache/yolov4_csp/ --tflite_path cache/yolov4_csp/assets/yolov4_csp.tflite --quant_type fp16"""
