...
class InferenceViewController: UIViewController {
  ...
  @IBOutlet weak var camType: UISegmentedControl!
  ...
  @IBAction func SwitchCamAction(_ sender: Any) {
    delegate?.didSwapCam(to: camType.selectedSegmentIndex, with: Int(threadStepper.value))
  }
  @IBAction func SwitchAction(_ sender: Any) {
    delegate?.didChangeModel(to: VersionController.selectedSegmentIndex, with: Int(threadStepper.value))
  }
