...
def runner(model, file_name, process_size, display_size):
  ...
  video = vs.VideoPlayer(file = file_name, post_process=model_run, disp_h=display_size)
...
if __name__ == '__main__':
  ...
  task, model = run.load_model(experiment='yolo_custom', config_path=config, model_dir=model_dir)
