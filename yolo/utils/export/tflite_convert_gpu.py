...
def convert_tiny():
  ...
  converter = tf.lite.TFLiteConverter.from_concrete_functions([runner.get_concrete_function(image)])
  ...
  converter = tf.lite.TFLiteConverter.from_concrete_functions([brunner.get_concrete_function(*inputs)])
  converter.optimizations = [tf.lite.Optimize.DEFAULT]
