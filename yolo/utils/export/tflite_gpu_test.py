...
def TfLiteModel(image, model_base = "detect-416.tflite", model_filter = "detect-tiny-filter-416.tflite"):
...
def TfLiteModelLarge(image, model_base = "detect-large-416.tflite", model_filter = "detect-filter3-416.tflite"):
	draw_fn = utils.DrawBoxes(classes=80, labels=None, display_names=False, thickness=2)
