...
nohup python3 -m centernet.train_vm --mode=eval --tpu=node-8 --experiment=centernet_tpu --model_dir=gs://tensorflow2/centernet-eval-tpu --config_file=centernet/configs/experiments/centernet-eval-tpu.yaml  > centernet-eval.log & tail -f centernet-eval.log
"""
