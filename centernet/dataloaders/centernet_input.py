...
class CenterNetParser(parser.Parser):
  ...
  def _build_heatmap_and_regressed_features1(self, 
                                            labels,
                                            output_size=[128, 128], 
                                            input_size=[512, 512]):
    ...
    for tag_ind in tf.range(num_objects):
      ...
      if self._use_gaussian_bump:
        ...
        tl_heatmaps = preprocessing_ops.draw_gaussian1(tl_heatmaps, [[obj_class, xtl, ytl, radius]])
        br_heatmaps = preprocessing_ops.draw_gaussian1(br_heatmaps, [[obj_class, xbr, ybr, radius]])
        ct_heatmaps = preprocessing_ops.draw_gaussian1(ct_heatmaps, [[obj_class, xct, yct, radius]], scaling_factor=5)
